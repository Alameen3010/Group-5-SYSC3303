...
public class Elevator implements Runnable {
    ...
    public boolean processSchedulerRequest() {
        ...
        switch (this.state) {
            ...
            case DOOR_OPENING:
                if (doorBroken) {
                    System.out.print(" State: Door is opening slower than usual (soft fault) " + " -> ");
                }
                else {
            ...
            case DOOR_CLOSING:
                if (doorBroken) {
                    System.out.print(" State: Door is closing slower than usual (soft fault) " + " -> ");
                }
                else {
            ...
            case CRUISING:
                ...
                try {
                    Thread.sleep((500 * (Math.abs(this.floorRequested - this.destinationFloor))));
                } catch (InterruptedException e) {
                    throw new RuntimeException(e);
                }
